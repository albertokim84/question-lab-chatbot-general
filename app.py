...
"누가(Who)", "언제(When)", "어디서(Where)", "무엇(What)"이라는 단어가 단순히 포함되었다고 **[R] Recognize (사실 확인)**로 인식하면 안 됩니다. **[I] Integrate (사실 연결)** 단계의 내용인지 검토 후 답을 하세요.
...
3. 유목화(Categorization): 분류하고 묶기(흩어진 정보들을 기준에 따라 서랍에 정리하는 사고)
